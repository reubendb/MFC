...
print(json.dumps({
    ...
    'patch_icpp(1)%z_centroid'     : 1.0E+00,
    ...
    'patch_icpp(2)%stl%file'       : 'pyramid.stl',
    'patch_icpp(2)%stl%scale(1)'   : 1.0/100.E+00,
    'patch_icpp(2)%stl%scale(2)'   : 1.0/100.E+00,
    'patch_icpp(2)%stl%scale(3)'   : 1.0/200.E+00,
